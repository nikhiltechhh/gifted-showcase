  ...
  return (
    <div className="fixed bottom-40 right-4 z-50">
      ...
      >
        {/* Floating Button */}
        <div
          className={`relative flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-green-500 rounded-full shadow-lg transition-all duration-300 ${
